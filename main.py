...
class GolfSimulator:
    ...
    def simulateShot(self, last_id, itterate=True):
        ...
        for player_id in range(start, last_id + 1):
            ...
            rounds_to_play = random.randint(1, 3)
    ...
    def shotRating(self):
        ...
        for item in self.positions:
            ...
            print('Finshed line 258 successfully')
    ...
    def write_to_csv(self, all_shots):
        fieldnames = ['round_id', 'player_id', 'hole_id', 'shot_id', 'start_coords', 'end_coords', 'club', 'bearing',
                      'rating']
...
if __name__ == '__main__':
    ...
    simulator.simulateShot(1000, itterate=True)
